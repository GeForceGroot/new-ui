...
const Benifits = () => {
    return (
        <>
                ...
                <div className="text-center section-heading">
                    <div className="heading-icons" style={{ display: 'flex', justifyContent: 'center' }}>
                        <div className="icon1">
                            ...
                            <img id='hex1' width="45" height="51" loading="lazy" src="https://cdn1.myassignment.live/mah-live/img/book.svg" alt="book" />
                        </div>
                        <div className="icon1">
                            <div className="hex "></div>
                    ...
                    <div data-aos="fade-left" data-aos-offset="400" data-aos-duration="1500" mirror='true'>
                        <h5 className="heading hidden" style={{ marginTop: "10px" }}>📖 Get Your Assignments Done Online With Us And Unlock Amazing Perks !</h5>
                    </div>
                </div>
            </section>
            <div className='container' id='prefer2' >
                <div className="row">
                    <div className="col-sm one-third item" id='blueBox' data-aos="flip-up" data-aos-offset="300" data-aos-duration="1500" mirror='true'>
                        <div className="hex"></div>
                    ...
                    <div className=" col-sm one-third item" id='greenBox' data-aos="flip-up" data-aos-offset="300" data-aos-duration="1500" mirror='true'>
                        <div className="hex"></div>
                ...
                <div className="row" style={{ marginTop: '15px' }}>
                    <div className="col-sm one-third item" id='greenBox' data-aos="flip-down" data-aos-offset="300" data-aos-duration="1500" mirror='true'>
                        <div className="hex"></div>
                    ...
                    <div className="col-sm one-third item" id='blueBox' data-aos="flip-down" data-aos-offset="300" data-aos-duration="1500" mirror='true'>
                        <div className="hex"></div>
            ...
            <div className='btnTalk' style={{ textAlign: "center", marginTop: '75px' }} data-aos="zoom-in" data-aos-offset="300" data-aos-duration="1000" mirror='true'>
            ...
            <hr style={{ marginLeft: "1300px", marginRight: "1300px", marginTop: '75px', marginBottom: "100px", border: "2px solid #030264" }} />
        </>
    )
}
