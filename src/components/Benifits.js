        ...
        <>
            <section className='prefer' id='prefer1' style={{ display: 'block' }}>
                <div className="text-center section-heading">
                    ...
                    <div data-aos="fade-up" data-aos-offset="400" data-aos-duration="1500" mirror='true'>
            ...
            <div className='container' id='prefer2' >
                <div className="row">
                    <div className="col-sm one-third item" id='blueBox' data-aos="flip-up" data-aos-offset="250" data-aos-duration="1500" mirror='true'>
                        <div className="hex"></div>
                    ...
                    <div className=" col-sm one-third item" id='greenBox' data-aos="flip-up" data-aos-offset="250" data-aos-duration="1500" mirror='true'>
                        <div className="hex"></div>
                ...
                <div className="row" style={{ marginTop: '15px' }}>
                    <div className="col-sm one-third item" id='greenBox' data-aos="flip-down" data-aos-offset="250" data-aos-duration="1500" mirror='true'>
                        <div className="hex"></div>
                    ...
                    <div className="col-sm one-third item" id='blueBox' data-aos="flip-down" data-aos-offset="250" data-aos-duration="1500" mirror='true'>
                        <div className="hex"></div>
            ...
            <div className='btnTalk' style={{ textAlign: "center", marginTop: '75px' }} data-aos="zoom-in" data-aos-offset="250" data-aos-duration="1000" mirror='true'>
            ...
            <hr style={{ marginLeft: "1250px", marginRight: "1250px", marginTop: '75px', marginBottom: "100px", border: "2px solid #030264" }} />
        </>
    )
}
