    ...
    return (
        <>
            <div className='container' style={{ textAlign: 'center' }}>
                <h5 style={{ color: "#030264" }}>Reviews Of The Students And Researchers<br />We Have Helped</h5>
                ...
                <h5 style={{ marginTop: '100px', color: '#030264' }}>Testimonials</h5>
            ...
            <div className='container' style={{ marginTop: "100px", marginBottom: "100px" }}>
                <div className="row text-center">
                    <div className="col-md-4 mb-5 mb-md-0">
                        ...
                        <h6 className=" mb-3" style={{ color: '#030264' }}>Happy Student</h6>
                        <p className="px-xl-3">
                    ...
                    <div className="col-md-4 mb-5 mb-md-0">
                        ...
                        <h6 className=" mb-3" style={{ color: "#030264" }}>Satisfied Customer</h6>
                        <p className="px-xl-3">
                    ...
                    <div className="col-md-4 mb-0">
                        ...
                        <h6 className="mb-3" style={{ color: "#030264" }}>Grateful Student</h6>
                        <p className="px-xl-3">
