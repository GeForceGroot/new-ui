        ...
        <>
            <section id='srviceBgset'>
                <div className='container servecieHome' id='servecieHome'>
                    <div className='hellooo' style={{ textAlign: "center" }} data-aos="flip-up" data-aos-offset="250" data-aos-duration="1500" mirror='true'>
                    ...
                    <div className='row' style={{ marginTop: '50px', textAlign: 'center' }} id='servrRow'>
                        <div className='col' id='serverCol' data-aos="zoom-in" data-aos-offset="250" data-aos-duration="1500" mirror='true'>
