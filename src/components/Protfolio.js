    ...
    <>
      <section id='bgServe'>
        <div className="container" style={{ textAlign: 'center' }} >
          <h3 id='animath5' style={{ color: "#15c39a", paddingTop: "100px" }} className="block-sub__title">Portfolio</h3>
          ...
          <div className='col-sm' id='carCssPort'>
            <div className="card" style={{ width: "20rem", border: '1px solid rgb(234, 236, 237)' }}>
              ...
              <div className="card-body">
                <h4 style={{color:"#15c39a"}} className="card-title">SOP for Canada Visa</h4>
