        ...
        <>
            ...
            <section id='servPointLeft' style={{ marginTop: '100px' }}>
                <div className='container'>
                    <div className="row">
                        <div className="col-md-6" id='animath6'>
                            <h5 style={{ color: '#15c39a', marginTop: '10px' }}>Essay Writing Services</h5>
                ...
                <div className='container'>
                    <div className="row" style={{ marginTop: '100px' }}>
                        <div className="col-md-6" id='animath5'>
                            <h5 style={{ color: '#15c39a' }}>Coursework Writing Services</h5>
                ...
                <div className='container'>
                    <div className="row" style={{ marginTop: '100px' }}>
                        ...
                        <div className="col-md-6" id='animath6'>
                            <h5 style={{ color: '#15c39a' }}>Case Study Help</h5>
                ...
                <div className='container'>
                    <div className="row" style={{ marginTop: '100px' }}>
                        <div className="col-md-6" id='animath5'>
                            <h5 style={{ color: '#15c39a' }}>Research Paper Writing</h5>
                ...
                <div className='container'>
                    <div className="row" style={{ marginTop: '100px' }}>
                        ...
                        <div className="col-md-6" id='animath6'>
                            <h5 style={{ color: '#15c39a', marginTop: "25px" }}>Thesis Writing</h5>
                ...
                <div className='container'>
                    <div className="row" style={{ marginTop: '100px' }}>
                        <div className="col-md-6" id='animath5'>
                            <h5 style={{ color: '#15c39a' }}>Assignment Help</h5>
            ...
            <section id='whyWatse' >
                ...
                <div className='container' style={{ textAlign: 'center', marginBottom: '40px', marginTop: '-10px' }}>
                    <h6 style={{ fontWeight: "700", color: '#079070' }}>Contact us for further details.</h6>
                </div>
