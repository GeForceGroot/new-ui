                        ...
                        <div className='col' style={{ marginTop: '175px', marginBottom: '175px' }}>
                            <div className='phone' style={{ marginTop: '75px', display: 'flex' }}>
                                ...
                                <div className='mix' style={{ marginLeft: '20px' }}>
                                    <h4 style={{ color: "#15c39a" }}>TALK TO OUR CLIENT SUPPORT TEAM</h4>
                                    <h2 style={{ color: 'darkorange' }}>+919048 815 031</h2>
                                </div>
                            </div>
                            <div className='phone' style={{ marginTop: '50px', display: 'flex' }}>
                                ...
                                <div className='mix' style={{ marginLeft: '20px' }}>
                                    <h4 style={{ color: "#15c39a" }}>WRITE TO US ABOUT YOUR NEEDS</h4>
                                    <h2 style={{ color: 'darkorange' }}>xyz@gmail.com</h2>
                                </div>
                            </div>
                            <div className='phone' style={{ marginTop: '50px', display: 'flex' }}>
                                ...
                                <div className='mix' style={{ marginLeft: '20px' }}>
                                    <h4 style={{ color: "#15c39a" }}>TALK TO OUR CLIENT SUPPORT TEAM</h4>
                                    <h2 style={{ color: 'darkorange' }}>Building No: 902 - Tower 2, National Empress Gardens Vennala, Kochi, Kerala, Pin- 682028</h2>
                                </div>
                            </div>
                        </div>
                        <div className='col' style={{ marginTop: '175px', marginBottom: '175px', textAlign: "center" }}>
                            {/* <!-- Contact 1 - Bootstrap Brain Component --> */}
                            <h2>Quick response and express delivery guaranteed !!!</h2>
                            <form className="form">
