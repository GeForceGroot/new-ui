                ...
                <div className="box hexagon">
                    ...
                    <div className="row" style={{marginTop:'50px'}}>
                        {hoverI ? (
                            ...
                            <div className="col-sm one-third" id='stdHelp' style={{ transition: "all 0.8s ease-in-out", transform: "translateX(.5%)", backgroundColor: "#f467f4", borderRadius: '15px', color: 'darkgre' }} onMouseLeave={handleHoverEnterI}>
                        ...
                        {hoverII ? (
                            ...
                            <div className="col-sm one-third" id='stdHelp' style={{ transition: "all 0.8s ease-in-out", transform: "translateX(.5%)", backgroundColor: "#b867f4", borderRadius: '15px', color: 'darkgre' }} onMouseLeave={handleHoverEnterII}>
                                <div className="hex" style={{ opacity: '0' }}>
                        ...
                        {hoverIII ? (
                            ...
                            <div className="col-sm one-third" id='stdHelp' style={{ transition: "all 0.8s ease-in-out", transform: "translateX(.5%)", backgroundColor: "lightblue", borderRadius: '15px', color: 'darkgre' }} onMouseLeave={handleHoverEnterIII}>
                                <div className="hex" style={{ opacity: '0' }}>
                        ...
                        <div className='row' style={{ marginTop: '50px', marginBottom: '50px' }}>
                            ...
                            {hoverIV ? (
                                ...
                                <div className="col-sm one-third" id='stdHelp' style={{ transition: "all 0.8s ease-in-out", transform: "translateX(.5%)", backgroundColor: "lightgreen", borderRadius: '15px', color: 'darkgre' }} onMouseLeave={handleHoverEnterIV}>
                                    <div className="hex" style={{ opacity: '0' }}>
                            ...
                            {hoverV ? (
                                ...
                                <div className="col-sm one-third" id='stdHelp' style={{ transition: "all 0.8s ease-in-out", transform: "translateX(.5%)", backgroundColor: "orange", borderRadius: '15px', color: 'darkgre' }} onMouseLeave={handleHoverEnterV}>
                                    <div className="hex" style={{ opacity: '0' }}>
                            ...
                            {hoverVI ? (
                                ...
                                <div className="col-sm one-third" id='stdHelp' style={{ transition: "all 0.8s ease-in-out", transform: "translateX(.5%)", backgroundColor: "#ff2323c7", borderRadius: '15px', color: 'darkgre' }} onMouseLeave={handleHoverEnterVI}>
                                    <div className="hex" style={{ opacity: '0' }}>
